...
class MatrixTester(unittest.TestCase):
    ...
    def test_eq(self):
        self.assertTrue(self.m2 == Matrix([[1, 1],
                                           [2, 1]]))
    ...
    def test_scalar_mult(self):
        self.assertEqual(self.m2*5, Matrix([[5, 5],
                                            [10, 5]]))
    ...
    def test_mult_col_matrix(self):
        self.assertEqual(self.m2*Matrix([[1],
                                         [3]]),  Matrix([[4],
                                                         [5]]))

    def test_cofactor(self):
        self.assertEqual(self.m3.get_cofactor(0, 0), Matrix([[1, 6],
                                                             [0, -10]]))
    ...
    def test_invertible(self):
        ...
        self.assertFalse(Matrix([[1, 2]]).is_invertible())

    def test_get_inverse(self):
        self.assertEqual(self.m3.get_inverse(), Matrix([[-5, 0, -2],
                                                        [-4, 1, -1],
                                                        [1.5, 0, 0.5]]))
        self.assertEqual(self.m4.get_inverse(), self.m4)

    def test_get_echelon_form(self):
        self.assertEqual(self.m3.get_echelon_form(), Matrix([[1, 0, 4],
                                                             [0, 1, 2],
                                                             [0, 0, 2]]))

    def test_get_reduced_echelon_form(self):
        self.assertEqual(self.m3.get_reduced_echelon_form(), Matrix([[1, 0, 0],
                                                                     [0, 1, 0],
                                                                     [0, 0, 2]]))
